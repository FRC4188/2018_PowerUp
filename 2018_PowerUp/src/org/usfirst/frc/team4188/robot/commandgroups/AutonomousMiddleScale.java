...
public class AutonomousMiddleScale extends CommandGroup {
    ...
    public AutonomousMiddleScale(String positions) {
    	...
    	if(side == 'L') {
    		...
    		addSequential(new AutoDriveDistanceBased(96.0/12 + RobotMap.ROBOT_WIDTH / 2 + RobotMap.ROBOT_LENGTH / 2, 0.1));
    		addSequential(new TurnToAngle(90.0, 0.1));
    		addSequential(new AutoDriveDistanceBased(304.0/12 - RobotMap.ROBOT_LENGTH, 0.1));
    		addSequential(new TurnToAngle(90.0, 0.1));
