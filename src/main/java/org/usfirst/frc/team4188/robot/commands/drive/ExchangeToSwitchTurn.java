 ...
 *
 */
public class ExchangeToSwitchTurn extends Command {
    private static int instanceCounterNext = 0;
    protected int instanceCounter = 0;
	
    public ExchangeToSwitchTurn() {
    ...
    protected void initialize() {
    	...
    	System.out.println("starting exchange to switch turn " + instanceCounter + " now ");
    }
    ...
    protected void end() {
    	...
    	System.out.println("ending exchange to switch turn " + instanceCounter + " now");
    ...
    protected void interrupted() {
    	System.out.println("interrupted exchange to switch turn " + instanceCounter);
    	end();
    }
}
