 ...
 *
 */
public class AutonomousRightScaleGoingRightDouble extends CommandGroup {

    public AutonomousRightScaleGoingRightDouble() {
		...
		addSequential(new AutoDriveDistanceBased(-4.0, 0.2), 1.3);
		...
		addParallel(new IntakeMotorsRun(0.5), 3.2);
